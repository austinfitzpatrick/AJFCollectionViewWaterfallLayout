...
#define COCOAPODS_POD_AVAILABLE_AJFCollectionViewWaterfallLayout
#define COCOAPODS_VERSION_MAJOR_AJFCollectionViewWaterfallLayout 0
#define COCOAPODS_VERSION_MINOR_AJFCollectionViewWaterfallLayout 1
#define COCOAPODS_VERSION_PATCH_AJFCollectionViewWaterfallLayout 0
